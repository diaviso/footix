                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Mon Profil', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
            ...
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Icon(Icons.shield_rounded, size: 14,
                    color: user.isAdmin ? const Color(0xFFF5A623) : AppColors.primary),
                const SizedBox(width: 4),
                Text(
  ...
  Widget _buildStatsCard(UserModel user) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Expanded(child: _buildStatTile(Icons.star_rounded, AppColors.primary, '${user.stars}', 'Étoiles')),
