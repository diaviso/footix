...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<void> googleLogin() async {
    state = state.copyWith(isLoading: true, clearError: true);
    try {
      // The Web client ID is required as serverClientId on Android
      // to obtain an idToken. Without it, idToken is always null.
      const webClientId = '756080273781-hkcuv88f7mme2e5n3ebmid02mdddo4ls.apps.googleusercontent.com';
      const iosClientId = '756080273781-jo5i7nden1ugk9hhnl13isaa8nk3rkaf.apps.googleusercontent.com';
