...
import '../features/quizzes/screens/revision_quiz_screen.dart';
...
class AppRoutes {
  ...
  static const String revisionQuiz = '/revision';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        parentNavigatorKey: _rootNavigatorKey,
        path: AppRoutes.revisionQuiz,
        pageBuilder: (context, state) => _buildTransitionPage(state, const RevisionQuizScreen()),
      ),
      GoRoute(
        parentNavigatorKey: _rootNavigatorKey,
