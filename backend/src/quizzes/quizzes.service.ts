...
- Le nombre d'options par question DOIT VARIER : certaines questions ont 2 options, d'autres 3, d'autres 4. Ne mets PAS systématiquement 4 options partout.
- Inclus des questions de type "Vrai ou Faux" ou "Oui/Non" (2 options seulement) pour environ 20-30% des questions.
- Pour les questions Vrai/Faux, les options sont : [{"content": "Vrai", ...}, {"content": "Faux", ...}]
