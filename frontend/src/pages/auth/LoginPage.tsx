      ...
      <Card className="border-0 shadow-2xl bg-white/95 dark:bg-[#141F1A]/95 backdrop-blur-xl overflow-hidden">
        ...
        <CardHeader className="space-y-1 pb-4 pt-6">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2.5 rounded-xl bg-[#D4AF37]/10 dark:bg-[#C0C0C0]/20">
              <LogIn className="h-5 w-5 text-[#D4AF37] dark:text-[#C0C0C0]" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 border-2 border-[#D1DDD6] dark:border-[#2D3F35] bg-white dark:bg-[#0D1512] focus:border-[#D4AF37] dark:focus:border-[#C0C0C0] focus:ring-[#D4AF37]/20 dark:focus:ring-[#C0C0C0]/20 transition-all duration-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-10 pr-10 h-12 border-2 border-[#D1DDD6] dark:border-[#2D3F35] bg-white dark:bg-[#0D1512] focus:border-[#D4AF37] dark:focus:border-[#C0C0C0] focus:ring-[#D4AF37]/20 dark:focus:ring-[#C0C0C0]/20 transition-all duration-200"
