    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37]/20 dark:focus-visible:ring-[#D4AF37]/20 focus-visible:ring-offset-2 focus-visible:border-[#D4AF37] dark:focus-visible:border-[#D4AF37]",
